...
class ViewPasswordsPage extends StatefulWidget {
  static route() => MaterialPageRoute(builder: (context) {
        return const ViewPasswordsPage();
      });
  const ViewPasswordsPage({super.key});

  @override
  State<ViewPasswordsPage> createState() => _ViewPasswordsPageState();
}

class _ViewPasswordsPageState extends State<ViewPasswordsPage> {
